fn main() -> anyhow::Result<()> {
    use pollster::FutureExt; // Block_on -> async calls
    ...
    let adapter = instance
        ...
        .block_on()
        .ok_or(anyhow::anyhow!("Cound't create the adapter"))?;
    ...
    // Load image
    let input_image = image::load_from_memory(include_bytes!("desk.png"))?.to_rgba8();
    ...
    {
        output_image.save("desk-grapyscale.png")?;
    }
    Ok(())
}
